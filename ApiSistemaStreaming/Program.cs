...
builder.Services.AddScoped<IConteudoInterface, ConteudoService>();
builder.Services.AddScoped<ICriadorInterface, CriadorService>();
builder.Services.AddScoped<IItemPlaylistInterface, ItemPlaylistService>();
